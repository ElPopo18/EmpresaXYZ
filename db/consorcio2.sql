...
ALTER TABLE
    `empresa` MODIFY `id` int(25) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `punto` MODIFY `id_punto` int(65) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `reunion` MODIFY `id_reunion` int(25) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `socio_has_punto` MODIFY `id` int(25) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `socio_has_punto` MODIFY `id_empresasoc` int(25) NOT NULL AUTO_INCREMENT;
